...
class ChatGPT3TelegramBot:
    ...
    async def info(self, update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
        """
        Показує доп повідомлення.
        """
        await update.message.reply_text("ChatGPT is an artificial intelligence chatbot developed by OpenAI and released in November 2022."
                                        "It is built on language models and has been fine-tuned using both supervised and reinforcement learning techniques.\n"
    ...
    async def is_allowed(self, update: Update) -> bool:
        ...
        allowed_user_ids = self.config["allowed_user_ids"].slpit(',')
